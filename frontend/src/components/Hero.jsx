...
function Hero() {
  ...
  return (
      <section className="bg-slate-50 dark:bg-slate-900 transition-colors duration-300">      <div className="max-w-7xl mx-auto px-6 py-24 lg:flex items-center justify-between">

        {/* Left Section */}
        <div className="lg:w-1/2">

          <span className="inline-block bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 px-4 py-1 rounded-full text-sm font-semibold mb-6">
        ...
        <div className="lg:w-1/2 mt-16 lg:mt-0 flex justify-center">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 w-[380px]">
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-between">
                <span className="text-slate-700 dark:text-slate-300">Average Rating</span>
              ...
              <div className="flex justify-between">
                <span className="text-slate-700 dark:text-slate-300">Positive Reviews</span>
